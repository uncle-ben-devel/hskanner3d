...
printf "This script captures photos. Command line flag options:
	[-n] Define a name to be added in front of the default folder name.
	...
	[-t] Timer for when you want to take selfies or something. Time in seconds to wait before capture.
...
# tutorial at https://www.lifewire.com/pass-arguments-to-bash-script-2200571
	...
	while getopts n:s:i:b:t:fr: option
	do
		case "${option}"
		in
			n) image_dir=$HOME/Pictures/${OPTARG}-$timestamp;;	# part of the name for the folder where the images will reside
